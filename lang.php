<?php
    ...
    if($lang['currentLang'] == 'en'){
        ...
        END;
        $lang['dinamic']['achievementPrompt'] = 'Type the name/nickname will be in your fastest shooter achievement:';
        $lang['dinamic']['completed'] = ' completed';
        $lang['dinamic']['description'] = $lang['description'];
        $lang['dinamic']['enemy'] = 'Enemy';
        $lang['dinamic']['enemyReaction'] = 'Enemy\'s reaction time: ';
        $lang['dinamic']['stuck'] = 'Stuck';
        $lang['dinamic']['stuckMsg'] = 'Attempts during the countdown stuck the shooter.';
        $lang['dinamic']['gameCompleted1'] = 'Game completed!!';
        $lang['dinamic']['gameCompleted2'] = 'You are the';
        $lang['dinamic']['gameCompleted3'] = 'fastest shooter!!';
        $lang['dinamic']['invalid'] = 'Invalid name, maximum of 40 characters aceppted!!';
        $lang['dinamic']['loading'] = 'Loading...';
        $lang['dinamic']['lvl'] = 'Level ';
        $lang['dinamic']['player'] = 'Player';
        $lang['dinamic']['players'] = 'Players';
        $lang['dinamic']['press'] = 'Press';
        $lang['dinamic']['reaction1'] = 'Player 1 reaction time: ';
        $lang['dinamic']['reaction2'] = 'Player 2 reaction time: ';
        $lang['dinamic']['ready'] = 'Game loaded!<br>Click or tap here to play';
        $lang['dinamic']['rotate'] = 'Rotate your device to play...🔄';
        $lang['dinamic']['shareAchievement'] = 'Share achievement';
        $lang['dinamic']['shoot'] = 'Shoot';
        $lang['dinamic']['taphere'] = 'Click/Tap here to continue';
        $lang['dinamic']['wasted'] = 'You are WASTED!!';
        $lang['dinamic']['wasStuck'] = ' was stuck';
        $lang['dinamic']['won1'] = 'Player 1 won!!';
        ...
        END;
        $lang['dinamic']['achievementPrompt'] = 'Escribe el nombre/apodo que estará en tu logro de tirador más rápido:';
        $lang['dinamic']['completed'] = ' completa';
        $lang['dinamic']['description'] = $lang['description'];
        $lang['dinamic']['enemy'] = 'Enemigo';
        $lang['dinamic']['enemyReaction'] = 'Tiempo de reacción del enemigo: ';
        $lang['dinamic']['stuck'] = 'Atascado';
        $lang['dinamic']['stuckMsg'] = 'Intentos durante la cuenta regresiva atascaron al tirador.';
        $lang['dinamic']['gameCompleted1'] = '¡Juego completado!';
        $lang['dinamic']['gameCompleted2'] = '¡Tu eres el tirador';
        $lang['dinamic']['gameCompleted3'] = 'mas rápido!';
        $lang['dinamic']['invalid'] = '¡Nombre/apellido no válido, se aceptan un máximo de 40 caracteres!';
        $lang['dinamic']['loading'] = 'Cargando...';
        $lang['dinamic']['lvl'] = 'Fase ';
        $lang['dinamic']['player'] = 'Jugador';
        $lang['dinamic']['players'] = 'Jugadores';
        $lang['dinamic']['press'] = 'Presione';
        $lang['dinamic']['reaction1'] = 'Tiempo de reacción del jugador 1: ';
        $lang['dinamic']['reaction2'] = 'Tiempo de reacción del jugador 2: ';
        $lang['dinamic']['ready'] = '¡Juego cargado!<br>Haga clic o toque aquí para jugar';
        $lang['dinamic']['rotate'] = 'Gira tu dispositivo para jugar...🔄';
        $lang['dinamic']['shareAchievement'] = 'Compartir logro';
        $lang['dinamic']['shoot'] = 'Dispara';
        $lang['dinamic']['taphere'] = 'Clic/Toca aquí para continuar';
        $lang['dinamic']['wasStuck'] = ' estaba atascado';
        $lang['dinamic']['wasted'] = '¡Fuiste EXTERMINADO!';
        $lang['dinamic']['won1'] = '¡Jugador 1 ganaste!';
        ...
        END;
        $lang['dinamic']['achievementPrompt'] = 'Digite o nome/apelido que estará na sua conquista de atirador mais rápido:';
        $lang['dinamic']['completed'] = ' concluído';
        $lang['dinamic']['description'] = $lang['description'];
        $lang['dinamic']['enemy'] = 'Inimigo';
        $lang['dinamic']['enemyReaction'] = 'Tempo de reação do Inimigo: ';
        $lang['dinamic']['stuck'] = 'Travado';
        $lang['dinamic']['stuckMsg'] = 'Tentativas durante a contagem regressiva travam o atirador.';
        $lang['dinamic']['gameCompleted1'] = 'Jogo concluído!!';
        $lang['dinamic']['gameCompleted2'] = 'Você é o atirador';
        $lang['dinamic']['gameCompleted3'] = 'mais rápido!!';
        $lang['dinamic']['invalid'] = 'Nome/apelido invalido, são aceitos no maximo 40 caracteres!';
        $lang['dinamic']['loading'] = 'Carregando...';
        $lang['dinamic']['lvl'] = 'Nível ';
        $lang['dinamic']['player'] = 'Jogador';
        $lang['dinamic']['players'] = 'Jogadores';
        $lang['dinamic']['press'] = 'Pressione';
        $lang['dinamic']['reaction1'] = 'Tempo de reação do jogador 1: ';
        $lang['dinamic']['reaction2'] = 'Tempo de reação do jogador 2: ';
        $lang['dinamic']['ready'] = 'Jogo carregado!<br>Clique ou toque aqui para jogar';
        $lang['dinamic']['rotate'] = 'Vire seu dispositivo para jogar...🔄';
        $lang['dinamic']['shareAchievement'] = 'Compartilhar conquista';
        $lang['dinamic']['shoot'] = 'Atire';
        $lang['dinamic']['taphere'] = 'Clique/Toque aqui para continuar';
        $lang['dinamic']['wasStuck'] = ' estava travado';
        $lang['dinamic']['wasted'] = 'Você foi EXTERMINADO!!';
        $lang['dinamic']['won1'] = 'Jogador 1 venceu!!';
