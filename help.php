<div id="helpOverlay">
    ...
    <?php 
        ...
        <h1>{$lang['name']}</h1>
        <ul>
            <h2><li>{$lang['help1']}</li></h2>
            <span class="helpSpan">{$lang['help2']}</span>
            <span class="helpSpan">{$lang['help3']}</span>
            <span class="helpSpan">{$lang['frozenMsg']}</span>
            <h2><li>{$lang['lang']}</li></h2>
            <button class="langBtn" onclick="document.cookie = `lang=en;expires=\${cookieExpires};`; location.reload()">English</button>
            <button class="langBtn" onclick="document.cookie = `lang=es;expires=\${cookieExpires};`; location.reload()">Español</button>
            <button class="langBtn" onclick="document.cookie = `lang=pt;expires=\${cookieExpires};`; location.reload()">Português</button>
            <div id="keyboardMapping">
            <h2><li>{$lang['help4']}</li></h2>
            <span class="helpSpan">{$lang['help5']}</span>
            <span class="helpSpan">{$lang['help6']}</span>
            <span class="helpSpan">{$lang['help7']}</span>
            </div>
            <h2><li>{$lang['about']}</li></h2>
